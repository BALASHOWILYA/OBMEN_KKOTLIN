package com.sad_ballala_projects.ObmenKnigami_Kotlin.dialogs
...
class RcViewDialogSpinnerAdapter(var tvSelection: TextView, var dialog : AlertDialog) : RecyclerView.Adapter<RcViewDialogSpinnerAdapter.SpViewHolder>() {
    ...
    class SpViewHolder(itemView: View, var tvSelectionn: TextView, var dialog: AlertDialog) : RecyclerView.ViewHolder(itemView), View.OnClickListener{
